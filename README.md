...
## Simulation Outputs & Architecture
The simulation generates analytical runtime assets and performance data including:
* **Latency Estimation:** Precise millisecond-level propagation delay calculations between ground stations and space nodes.
* **Visual Representation (Representative Outputs):**
  > *Academic Note:* The figures below illustrate representative outputs generated by the proposed framework. They are intended to visualize the behavior of the analytical model rather than to represent a full-scale operational LEO constellation.
